    ...
    <div class="container text-center mt-5">
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 mb-3">
                ...
                <p class="small">Enjoy fast, reliable delivery on all orders over $150.</p>
            </div>
            <div class="col-md-4 mb-3">
                <i class="bi bi-award fs-1 text-success"></i>
                <h5 class="mt-2">Quality Guaranteed</h5>
                <p class="small">We handpick every item to ensure style and durability.</p>
            </div>
            <div class="col-md-4 mb-3">
                <i class="bi bi-chat-dots fs-1 text-warning"></i>
                <h5 class="mt-2">Personalized Support</h5>
                <p class="small">Our team is here to help with styling or order assistance.</p>
            </div>
        </div>
    </div>
